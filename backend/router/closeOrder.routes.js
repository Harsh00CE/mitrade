...
router.post("/", async (req, res) => {
    try {
        ...
        const closedOrder = new ClosedOrdersModel({
            ...
            takeProfit: typeof openOrder.takeProfit === "number" ? openOrder.takeProfit.value : undefined,
            stopLoss: typeof openOrder.stopLoss === "number" ? openOrder.stopLoss.value : undefined,
            realisedPL,
