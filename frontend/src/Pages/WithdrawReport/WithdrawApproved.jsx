// src/pages/WithdrawApproved.jsx
...
const WithdrawApproved = () => {
  ...
  const fetchWithdrawals = async () => {
    try {
      ...
      setWithdrawals(res.data.data.filter((item) => item.status === 'approved'));
    } catch (err) {
  ...
  return (
    <div className="p-6 bg-gray-900 text-white min-h-screen">
      ...
      <h2 className="text-2xl font-bold mb-4">Approved Withdrawals</h2>
